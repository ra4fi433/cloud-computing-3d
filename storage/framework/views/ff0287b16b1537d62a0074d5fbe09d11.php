...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-white hover:text-yellow rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ms-3 underline border border-[12px] font-bold py-2 px-4 rounded preview-button hover:bg-[#004eb5] hover:text-white transition','style' => 'color: #004eb5; background-color: #ffffff; border-color: #004eb5; ']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-3 underline border border-[12px] font-bold py-2 px-4 rounded preview-button hover:bg-[#004eb5] hover:text-white transition','style' => 'color: #004eb5; background-color: #ffffff; border-color: #004eb5; ']); ?>
