...
<body>
    ...
    <div class="ttd-section">
        ...
        @if ($surat->kadis_ttd_status === 'elektronik')
            ...
            @else
                ...
                <div class="signature-box">
                    <img src="{{ public_path('Logo-kota.png') }}" alt="Logo Pemerintah Kota Semarang" style="width: 30px; float: left; margin-right: 10px;">
        ...
        @if ($kadisTtd)
            ...
            NIP {{ $kadisTtd->nip ?? '196702261986031001' }}</p>
        @else
    ...
    <div class="footer">
        ...
        <img src="{{ public_path('qrcode.png') }}" width="80"> {{-- Pastikan qrcode.png ada di public folder --}}
    </div>
