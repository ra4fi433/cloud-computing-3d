<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-3 underline border border-[12px] font-bold py-2 px-4 rounded preview-button hover:bg-[#004eb5] hover:text-white transition" style="color: #004eb5; background-color: #ffffff; border-color: #004eb5; ">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
